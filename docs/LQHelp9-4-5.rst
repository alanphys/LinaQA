...
The 'First frame' and 'Last frame' can be changed on the fly from a pop up window opened by long or right mouse click on the |tu| button. Default values for the 'First frame' and 'Last frame' as well as other settings can be set in :ref:`tomouniformitysettings` settings.
